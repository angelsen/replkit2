...
def welcome(state):
    ...
    return {
        "frontmatter": {
            "title": "Welcome to ReplKit2 Markdown",
            "version": "1.0",
            "author": "ReplKit2 Team"
        },
        "elements": [
            ...
            {"type": "code_block", "content": '@app.command(display="markdown")\ndef my_command(state):\n    return {"elements": [...]}', "language": "python"},
            
            {"type": "blockquote", "content": "The markdown formatter preserves the data-first philosophy of ReplKit2."},
...
def guide(state):
    ...
    return (markdown()
        ...
        .code_block("""from replkit2.textkit import markdown
...
def api_docs(state):
    ...
    return {
        ...
        "elements": [
            ...
            {"type": "code_block", "content": """class MyElement(MarkdownElement):
    ...
    def render(self) -> str:
        ...
        pass""", "language": "python"},
            ...
            {"type": "text", "content": "Elements automatically register when the class is defined. No manual registration needed!"},
