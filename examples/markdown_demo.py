...
def welcome(state):
    ...
    return {
        ...
        "elements": [
            ...
            {"type": "alert", "content": "New in v0.10.0: Table and Alert elements!", "level": "success"},
...
def api_docs(state):
    ...
    def render(self) -> str:
        ...
        pass""",
            ...
            {
                "type": "text",
                "content": "Elements must be explicitly registered using register_element() in v0.10.0+.",
            },
            {
                "type": "list",
                "items": [
